...
public:
	...
	bool Move(Ogre::Vector3 vector, Real speed = 1.0f, bool flip = true);
	bool MovePosition(Ogre::Vector3 vector, Real speed = 1.0f);
	void Rotate(const Ogre::Vector3 &position, Real speed = 1.0f);
	void RotateLocal(const Ogre::Vector3 &position, Real speed = 1.0f);
	...
	void Loop();
	void Strafe(Real speed = 1.0f);
	void Step(Real speed = 1.0f);
	void Float(Real speed = 1.0f);
	void Jump();
	void Look(Real speed = 1.0f);
	void Turn(Real speed = 1.0f);
	void Spin(Real speed = 1.0f);
