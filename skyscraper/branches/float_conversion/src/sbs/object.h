...
public:
	...
	virtual void Move(const Ogre::Vector3 &vector, Real speed = 1.0f);
	virtual void Move(Real X, Real Y, Real Z, Real speed = 1.0f);
	...
	virtual void Rotate(const Ogre::Vector3 &vector, Real speed = 1.0f);
	virtual void Rotate(Real X, Real Y, Real Z, Real speed = 1.0f);
