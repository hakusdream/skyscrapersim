...
Floor::Floor(int number)
{
	...
	Level_state = scfQueryInterface<iGeneralFactoryState> (Level->GetMeshObject()->GetFactory());
	...
	Interfloor_state = scfQueryInterface<iGeneralFactoryState> (Interfloor->GetMeshObject()->GetFactory());
	...
	ColumnFrame_state = scfQueryInterface<iGeneralFactoryState> (ColumnFrame->GetMeshObject()->GetFactory());
